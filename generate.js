...
// 7. התאוששות מאסון (DR)
S([
  h1('7. התאוששות מאסון (DR)'),
  note('תוכנית ההתאוששות, יעדי השירות, נהלי השחזור והתרגולים — היערכות להמשכיות עסקית באתר.'),
  h2('7.1 תוכנית התאוששות (DR Plan)'),
  kvTable(['תוכנית DR מתועדת (קיימת / היכן)', 'תאריך עדכון אחרון', 'אחראי DR (בעל התוכנית)', 'אתר חלופי (DR Site) — מיקום / ענן / אין', 'אסטרטגיה (Backup&Restore / Warm Standby / Active-Active)']),
  spacer(),
  h2('7.2 יעדי שחזור למערכות קריטיות'),
  note('RTO — כמה זמן עד חזרה לפעילות. RPO — כמה נתונים מותר לאבד (חלון הגיבוי).'),
  dataTable(['מערכת / שירות', 'RTO (יעד זמן שחזור)', 'RPO (יעד אובדן נתונים)', 'עדיפות שחזור'],
    [2.2, 1.9, 1.9, 1.5],
    { examples: [['שרת קבצים', '4 שעות', '24 שעות', 'גבוהה']], empty: 4 }),
  spacer(),
  h2('7.3 נוהל שחזור (Recovery Runbook)'),
  kvTable(['סדר שחזור מערכות (עדיפויות)', 'מיקום הגיבויים לשחזור', 'נוהל מעבר לאתר חלופי (Failover)', 'נוהל תקשורת באירוע (מי מעדכן, ערוצים)', 'אימות תקינות אחרי שחזור']),
  spacer(),
  h2('7.4 תרגולים ובדיקות'),
  dataTable(['תאריך', 'סוג תרגיל', 'היקף', 'תוצאה / ממצאים', 'יעד לטיפול'],
    [1.1, 1.5, 1.6, 2.3, 1.3],
    { examples: [['03/2026', 'Restore', 'שרת קבצים', 'הצליח — 3 שעות', '—']], empty: 4 }),
  spacer(),
  h2('7.5 אנשי קשר וספקים ל-DR'),
  dataTable(['תפקיד', 'שם', 'טלפון', 'ספק / חיצוני'],
    [1.8, 1.8, 1.5, 1.6],
    { examples: [['מוביל DR', '—', '—', 'פנימי']], empty: 4 }),
]);

// 8. ספקים וחוזי תמיכה
S([
  h1('8. ספקים וחוזי תמיכה'),
...
// 9. אנשי קשר ומדרג הסלמה
S([
  h1('9. אנשי קשר ומדרג הסלמה'),
